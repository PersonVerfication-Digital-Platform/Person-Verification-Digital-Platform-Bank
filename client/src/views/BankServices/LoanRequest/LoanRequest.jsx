...
const LoanRequest = () => {
  const text =
    "Bank loan request is a highly confidential process. You can either follow the manual process or use your DID to proceed";
  const navigate = useNavigate();

  function handleClick() {
    // alert("Clicking from bank loans");
    navigate("/qr-scan", { state: { service: "loan-request" } });
  }
